...
cat_models_native = CatBoostClassifier(cat_features=['Sex', 'Embarked'], verbose=0)
cat_models_native.fit(X_train, y_train)

# Predict and evaluate
cat_pred_native = cat_models_native.predict(X_test)
